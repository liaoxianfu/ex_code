...
class TmfHead(BaseDecodeHead):
    def __init__(self, pool_scales=(1, 2, 3, 6),dilations=(1, 6), **kwargs):
        super(TmfHead, self).__init__(
        ...
        self.aspp_dwon_chs = nn.Conv2d(self.channels*2,self.channels,kernel_size=1,stride=1)
        self.tch_dwon_chs = ConvModule(
            self.channels*2,
            self.channels,
            3,
            padding=1,
        ...
        for in_channels in self.in_channels[:-1]:  # skip the top layer
            ...
            if i==0:
                fpn_conv = nn.Sequential(
                    nn.Conv2d(self.channels,self.channels,kernel_size=1,stride=1),
                    ConvModule(
                        self.channels,
                        self.channels,
                        7,
    ...
    def _forward_feature(self, inputs):
        ...
        laterals.append(self.tmf_forword(inputs))
