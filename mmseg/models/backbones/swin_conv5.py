...
class SwinTransformerWithConv5(BaseModule):
    ...
    def __init__(self,
        ...
        super(SwinTransformerWithConv5, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerWithConv5, self).train(mode)
        self._freeze_stages()
    ...
    def forward(self, x):
        ...
        for i, stage in enumerate(self.stages):
            x, hw_shape, out, out_hw_shape = stage(
                annt.flatten(2).transpose(1, 2), hw_shape)
