...
class SwinTransformerConv8(BaseModule):
    ...
    def __init__(self,
        ...
        super(SwinTransformerConv8, self).__init__(init_cfg=init_cfg)
    ...
    #############################自定义模型开始###########################################
        ...
        for i in range(4):
            merge_layer = ConvModule(dims[i]*2,dims[i],kernel_size=3,stride=1,padding=1,act_cfg=dict(type='GELU'))
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerConv8, self).train(mode)
        self._freeze_stages()
