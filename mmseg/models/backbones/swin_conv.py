...
class SwinTransformerWithConv(BaseModule):
    ...
    def __init__(self,
        ...
        super(SwinTransformerWithConv, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerWithConv, self).train(mode)
        self._freeze_stages()
    ...
    def forward(self, x):
        ...
        if self.convAttentions[0] != None:
            ...
            x = (1 - self.conv_attn_rate) * x + self.conv_attn_rate * x_
        if self.use_abs_pos_embed:
