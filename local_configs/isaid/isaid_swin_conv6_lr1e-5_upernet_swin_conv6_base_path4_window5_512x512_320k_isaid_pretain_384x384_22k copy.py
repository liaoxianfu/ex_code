_base_ = [
    '../_base_/models/upernet_swinconv6.py', '../_base_/datasets/isaid512.py',
...
model = dict(
    ...
    auxiliary_head=dict(in_channels=512, num_classes=16))
...
evaluation = dict(interval=32000, metric=['mIoU','mFscore'], pre_eval=True)
