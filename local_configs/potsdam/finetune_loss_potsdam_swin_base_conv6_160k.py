_base_ = [
    '../_base_/models/tchnet_swinconv6.py', '../_base_/datasets/potsdam.py',
...
checkpoint_file = 'pretrain/finetune/ch04_loss_isaid_swin_base_conv6_320K-e4c68f4f.pth' 
model = dict(
    backbone=dict(
    ...
    # decode_head=dict(in_channels=[128, 256, 512, 1024], num_classes=16),
    ...
    decode_head=dict(
           loss_decode=[dict(type='FocalLoss', loss_name='loss_focal', loss_weight=0.4),
                   ...
                   in_channels=[128, 256, 512, 1024], num_classes=6
          )
    )


# AdamW optimizer, no weight decay for position embedding & layer norm
# in backbone FocalLoss
optimizer = dict(
    _delete_=True,
    type='AdamW',
    lr=1e-5,
